 ...
 */
public class InterfazPerfilRevender extends JFrame {

    private static InterfazPerfilRevender instancia;

    public InterfazPerfilRevender() {
        // JFrame
        ...
        JLabel texto1 = new JLabel("Seleccionar Boletos a Revender");
        ...
        continuar.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                InterfazPerfilRevender2.getInstance().setVisible(true);
                frame.dispose();
            }
        });
    ...
    public static InterfazPerfilRevender getInstance() {
        if (instancia == null) {
            instancia = new InterfazPerfilRevender();
        }
        return instancia;
    }
