...
public class InterfazPerfil extends JFrame {
    ...
    public InterfazPerfil(Persona personachila) {
        ...
        JButton botonPersonalizar = new JButton("Personalizar Perfil");
        ...
        botonPersonalizar.setFont(new Font("Arial", Font.BOLD, 14));
        botonPersonalizar.setBackground(new Color(0x65, 0x55, 0x8F));
        botonPersonalizar.setForeground(Color.BLACK);
        botonPersonalizar.setSize(160, 40);
        botonPersonalizar.setLocation(posX, 340);
        ...
        botonPersonalizar.addActionListener(e -> {
    new ActualizarDatosPersonaFrame(personaChida).setVisible(true);
});
